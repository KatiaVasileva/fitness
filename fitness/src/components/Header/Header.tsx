  ...
  return (
    <div className="container mx-auto">
      <div className="h-50 flex flex-row items-center place-content-between mb-4">
        <img src="/img/logo.png" className="w-55"></img>
        <button className="bg-green w-26 h-13 text-black hover:bg-light-green">Войти</button>
      ...
      <p className="text-lg/5 font-normal text-gray">Онлайн-тренировки для занятий дома</p>
    </div>
  );
}
